      ...
      JSXOpeningElement: {
        exit: function exit(path, state) {
          if (css != null) {
            ...
            if (progPath != null) {
              progPath.unshiftContainer('body', t.variableDeclaration('var', [t.variableDeclarator(t.identifier(libName), t.callExpression(t.identifier('require'), [t.stringLiteral(mod)]))]));
              progPath = null;
            }
            // Process classes
            var classes = [];
